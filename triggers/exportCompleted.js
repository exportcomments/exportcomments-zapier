...
export default {
  ...
  operation: {
    ...
    sample: {
      ...
      "preview_url": "https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fexportcomments.com%2Fexports%2Fig-posts_mypage_f5f93319.xlsx%3Fnocache%3D1756282740&wdOrigin=BROWSELINK",
      "status_url": "https://exportcomments.com/done/test-export-uuid",
      "delete_after": "2024-01-20T10:40:00Z",
      "json_url": "https://exportcomments.com/exports/a931e7af58a9926641a9addb0d45306d-test-export-uuid.json",
      "masked_metadata": {
        "export_duration": 20.618
      },
    ...
    outputFields: [
      ...
      { key: 'json_url', label: 'JSON URL', type: 'string' },
      { key: 'status_url', label: 'Status URL', type: 'string' },
      { key: 'delete_after', label: 'Delete After', type: 'datetime' },
      { key: 'masked_metadata__export_duration', label: 'Export Duration', type: 'number' },
