...
const performList = async (z, bundle) => {
  const options = {
    url: 'https://exportcomments.com/api/v1/webhooks/events?event=export.created',
    method: 'GET',
    headers: {
      'X-AUTH-TOKEN': bundle.authData.api_key,
      'Accept': 'application/json'
...
const performListSample = async (z, bundle) => {
  const options = {
    url: 'https://exportcomments.com/api/v1/zapier/events/export.created/sample',
    method: 'GET',
    headers: {
      'X-AUTH-TOKEN': bundle.authData.api_key,
      'Accept': 'application/json'
...
export default {
  ...
  operation: {
    ...
    sample: {
      ...
      "message_id": "test-export-created-123",
