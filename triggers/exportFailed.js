...
const performList = async (z, bundle) => {
  const options = {
    url: 'https://exportcomments.com/api/v1/webhooks/events?event=export.failed',
    method: 'GET',
    headers: {
      'X-AUTH-TOKEN': bundle.authData.api_key,
      'Accept': 'application/json'
...
export default {
  ...
  operation: {
    ...
    sample: {
      ...
      "total_exported": 0,
      "retry": 2,
      "error": "The provided URL could not be accessed or contains private content",
      "replies_count": 0,
      "twitter_type": false,
      "options": {
        "tweets": true,
      ...
      "delete_after": "2024-01-20T10:35:00Z",
      "json_url": null,
      "masked_metadata": null,
      "message_id": "test-export-failed-123",
